...
`, config, snPath)
	...
	buildkitdArgs := []string{
		...
		"--containerd-worker-labels=org.mobyproject.buildkit.worker.sandbox=true", // Include use of --containerd-worker-labels to trigger https://github.com/joshuakb2/buildkit/pull/603
	}
