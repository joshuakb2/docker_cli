...
func init() {
	typeurl.Register((*Vertex)(nil), "github.com/joshuakb2/buildkit", "errdefs.Vertex+json")
	typeurl.Register((*Source)(nil), "github.com/joshuakb2/buildkit", "errdefs.Source+json")
}
